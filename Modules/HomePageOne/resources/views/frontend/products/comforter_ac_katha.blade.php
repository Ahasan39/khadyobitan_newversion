<section class="top-products ">
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="section-title" style="color:#ff00aa; font-weight:700;">
                    Comforter Set & AC Katha
                </h2>
                <a href="#" class="see-all-btn btn btn-sm"
                    style="background:#ff00aa; color:#fff; border-radius:3px;">
                    সবগুলো দেখুন ➡
                </a>
            </div>

            <!-- Running Category Marquee -->
            <div class="category-marquee">
                <div class="marquee-content">
                    <span>⚡ Comforter Set</span>
                    <span>⚡ AC Katha Set</span>
                    <span>⚡ Comforter Set</span>
                    <span>⚡ AC Katha Set</span>
                    <span>⚡ Comforter Set</span>
                    <span>⚡ AC Katha Set</span>
            ...
            <div class="mt-2 mb-4">
                <img width="100%" src="{{ asset('modules/homepageone/frontend/img/banner-4.jpg') }}"
                    alt="">
            </div>
            <!-- Product Grid -->
            <div class="row g-3">
