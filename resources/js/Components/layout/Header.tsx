...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`relative lg:sticky lg:top-0 z-50 transition-all duration-300 border-b ${scrolled
      ...
      >
        <div className="container-custom flex items-center justify-between h-14 lg:h-16">
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.path}
                  href={link.path}
                  className={`relative px-3.5 py-2 rounded-full text-sm font-medium font-body tracking-wide transition-all duration-200 ${isActive
          ...
          <div className="flex items-center gap-0.5 sm:gap-1 lg:gap-1.5">
            ...
            <Link href="/login" className="p-2 rounded-full hover:bg-muted transition-colors hidden lg:flex" aria-label={t("nav.account")}>
              <User className="h-5 w-5 text-foreground/75" />
            </Link>
            <Link href="/wishlist" className="p-2 rounded-full hover:bg-muted transition-colors relative hidden lg:flex" aria-label={t("nav.wishlist")}>
            ...
            <Link href="/cart" className="p-2 rounded-full hover:bg-muted transition-colors relative hidden lg:flex" aria-label={t("nav.cart")}>
                ...
                {navLinks.map((link) => {
                  ...
                  return (
                    <Link
                      key={link.path}
                      href={link.path}
                      className={`py-2.5 px-3 rounded-lg font-body text-base font-medium transition-all ${isActive
                        ? "text-primary bg-primary/10"
