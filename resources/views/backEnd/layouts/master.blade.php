        ...
        <div class="navbar-custom">
            <div class="container-fluid">
                ...
                <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                    ...
                    <li class="dropdown d-none d-xl-block">
                        <a class="nav-link dropdown-toggle waves-effect waves-light "
                          href="{{ route('analytics.index') }}"> <span
                                class="btn btn-warning waves-effect waves-light  rounded-pill"> <i
                                    data-feather="pie-chart"></i>Visitors</span> </a>
                    </li>
                    ...
                    <li class="dropdown d-none d-xl-block">
                        <a class="nav-link dropdown-toggle waves-effect waves-light "
                          href="{{ route('expense.index') }}"> <span
                                class="btn btn-blue waves-effect waves-light  rounded-pill"> <i
                                    data-feather="dollar-sign"></i>Expense</span> </a>
                    </li>
                    <li class="dropdown d-none d-xl-block">
                         <a class="nav-link dropdown-toggle waves-effect waves-light" href="{{route('admin.courier.status_update')}}"  onclick="event.preventDefault();
                                                     document.getElementById('auto_update_form').submit();"> <span
                                class="btn btn-success waves-effect waves-light  rounded-pill">  <i class="fe-refresh-cw"></i> Courier Update </span> </a>
                        <form id="auto_update_form" action="{{route('admin.courier.status_update')}}" method="POST"> @csrf 
            ...
            <div class="h-100" data-simplebar>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul id="side-menu">
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-orders">
                                <ul class="nav-second-level">
                                    ...
                                    @endforeach
                                    <li>
                                        <a href="{{ route('admin.incomplete_orders.index') }}">
                                            <i data-feather="minus"></i>Incomplete Orders
                                            @if($incompleteOrdersCount > 0)
                                                <span class="badge bg-warning rounded-pill ms-1">{{ $incompleteOrdersCount }}</span>
                                            @endif
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ route('reviews.index') }}"><i
                                                data-feather="minus"></i>Reviews</a>
                                    </li>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="siebar-purchase">
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ route('products.purchase') }}"><i
                                                data-feather="minus"></i>Purchase List</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                    ...
                                    <li>
                                     ...
                                     <li>
                                        <a href="{{ route('customer_reviews.index') }}">
                                            <i data-feather="minus"></i>Image Reviews</a>
                                    </li>
                                     <li>
                                        <a href="{{ route('product_reviews.manage') }}">
                                            <i data-feather="minus"></i>Customer Product Reviews</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="siebar-sitesetting">
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ route('theme.setting.index') }}"><i data-feather="minus"></i>
                                            Theme Color Setting</a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="{{ route('notice.index') }}"><i data-feather="minus"></i>
                                            Notice</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('offers.index') }}"><i data-feather="minus"></i>
                                            Offer</a>
                                    </li>
                                    
                                    <li>
                                        <a href="{{ route('contact.userMessage') }}"><i data-feather="minus"></i>
                                            User Message</a>
                                    </li>
                                    
                                    <li>
                                        <a href="{{ route('shippingcharges.index') }}"><i data-feather="minus"></i>
                                            Shipping Charge</a>
                                    </li>
                                    <li>
                                   ...
                                   <li>
                                        <a href="{{ route('admin.business_setting') }}">
                                            <i data-feather="minus"></i>Business Setting
                                        </a>
                                    </li>

                                     <li>
                                        <a href="{{ route('checkout.content') }}">
                                            <i data-feather="minus"></i> Checkout Content
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('feature.toggles.index') }}">
                                            <i data-feather="minus"></i> Feature Toggles
                                        </a>
                                    </li>
                                     <li>
                                        <a href="{{ route('backEnd.permissions.index') }}">
                                            <i data-feather="minus"></i> Update Permission
                                        </a>
                                    </li>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-pixel-gtm">
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ route('analytics.index') }}"><i
                                                data-feather="minus"></i>
                                            Visitor Reports
                                        </a>
                                    </li>
                        ...
                        <li>
                            <a href="#sitebar-update" data-bs-toggle="collapse">
                                <i data-feather="pie-chart"></i>
                                <span> Update </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sitebar-update">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ url('admin/licenses') }}"><i data-feather="minus"></i>
                                           Pin setup</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('viewLogs') }}"><i data-feather="minus"></i>
                                            Version History</a>
                                    </li>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 text-end">&copy; {{ $generalsetting->name ?? ' '   }} <a
                                href="https://webleez.com" target="_blank">webleez</a></div>
                    </div>
                </div>
            </footer>
            <!-- end Footer -->
