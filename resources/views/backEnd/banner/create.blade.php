...
@section('content')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('Slug') is-invalid @enderror"
                                        name="Slug" value="{{ old('Slug') }}" id="Slug" readonly>
                                    @error('Slug')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
    ...
    // normalize to keep combining marks with letters
    let normalized = title.normalize("NFC");

    let slug = normalized
        .replace(/[^\p{L}\p{M}\p{N}\s-]/gu, '')  // allow letters, marks (কার), numbers
        .trim()
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('button_link') is-invalid @enderror"
                                        name="button_link" value="{{ old('button_link') }}" id="button_link"
                                      >
                                    @error('button_link')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
