                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            @foreach(old('purchase_prices', ['']) as $key => $purchase_price)
    <input type="text"
        class="form-control @error('purchase_prices.' . $key) is-invalid @enderror"
        name="purchase_prices[]"
        value="{{ $purchase_price }}"
        id="purchase_prices_{{ $key }}" />
@endforeach
                                    ...
                                    <!-- col-end -->
                                   @foreach(old('old_prices', ['']) as $key => $old_price)
<div class="col-sm-2">
    <div class="form-group">
        <label for="old_prices_{{ $key }}" class="form-label">Old Price </label>
        <input type="text"
            class="form-control @error('old_prices.' . $key) is-invalid @enderror"
            name="old_prices[]"
            value="{{ $old_price }}"
            id="old_prices_{{ $key }}" />
        @error('old_prices.' . $key)
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        @enderror
...
@endforeach
                                    ...
                                    <!-- col-end -->
                                   @foreach(old('new_prices', ['']) as $key => $new_price)
<div class="col-sm-2">
    <div class="form-group">
        <label for="new_prices_{{ $key }}" class="form-label">New Price *</label>
        <input type="text"
            class="form-control @error('new_prices.' . $key) is-invalid @enderror"
            name="new_prices[]"
            value="{{ $new_price }}"
            id="new_prices_{{ $key }}" />
        @error('new_prices.' . $key)
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        @enderror
...
@endforeach
                                   ...
                                   @foreach(old('pro_barcodes', ['']) as $key => $pro_barcode)
<div class="col-sm-6">
    <div class="form-group">
        <label for="pro_barcodes_{{ $key }}" class="form-label">Product Barcode</label>
        <input type="text"
            class="form-control @error('pro_barcodes.' . $key) is-invalid @enderror"
            name="pro_barcodes[]"
            value="{{ $pro_barcode }}"
            id="pro_barcodes_{{ $key }}">
        @error('pro_barcodes.' . $key)
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        @enderror
...
@endforeach
    ...
    <div class="form-group">
        ...
        <input type="text"
            ...
            name="purchase_prices[]" 
            value="{{ old('purchase_prices.0') }}"  {{-- Adjust index dynamically if looping --}}
            id="purchase_prices" />
    ...
    <div class="form-group">
        ...
        <input type="text"
            ...
            name="old_prices[]" 
            value="{{ old('old_prices.0') }}" {{-- Adjust index if you’re looping --}}
            id="old_prices" />
        @error('old_prices.*')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
    ...
    <div class="form-group">
        ...
        <input type="text"
            ...
            name="new_prices[]" 
            value="{{ old('new_prices.0') }}" {{-- Use .index if inside a loop --}}
            id="new_prices" />
        @error('new_prices.*')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
    ...
    <div class="form-group">
        ...
        <input type="text"
            ...
            name="stocks[]" 
            value="{{ old('stocks.0') }}" {{-- Use .index if in a loop --}}
            id="stocks">
        @error('stocks.*')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
    ...
    <div class="form-group">
        ...
        <input type="text"
            ...
            name="pro_barcodes[]" 
            value="{{ old('pro_barcodes.0') }}"  {{-- First item --}}
            id="pro_barcodes">
        @error('pro_barcodes.*')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
...
<div id="tag-buttons">
   ...
   <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="stocks" class="form-label">Tag</label>
    ...
    <div class="policy-item border p-3 rounded mb-3">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label>Title</label>
                    <input type="text" name="policy_title[]" class="form-control" placeholder="Shipping Policy">
                </div>
            </div>
            ...
            <div class="col-md-5">
                <div class="form-group">
                    ...
                    <textarea name="policy_description[]" rows="4"
...
<button type="button" id="add-policy" class="btn btn-sm btn-primary mt-2"><i class="fa fa-plus"></i> Add Policy</button>

</div>
                            
                          <div class="col-sm-6">
    <div class="form-group mb-3">
        <label for="shipping_title_dhaka" class="form-label">Shipping Title (Inside Dhaka)</label>
        <input type="text" class="form-control @error('shipping_title_dhaka') is-invalid @enderror"
               name="shipping_title_dhaka" value="{{ old('shipping_title_dhaka') }}">
        @error('shipping_title_dhaka')
        ...
        @enderror
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                <label for="shipping_amount_dhaka" class="form-label">Shipping Amount (Inside Dhaka)</label>
                                <input type="number" step="0.01" class="form-control @error('shipping_amount_dhaka') is-invalid @enderror"
                                       name="shipping_amount_dhaka" value="{{ old('shipping_amount_dhaka') }}">
                                @error('shipping_amount_dhaka')
                                    <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                <label for="shipping_title_outside_dhaka" class="form-label">Shipping Title (Outside Dhaka)</label>
                                <input type="text" class="form-control @error('shipping_title_outside_dhaka') is-invalid @enderror"
                                       name="shipping_title_outside_dhaka" value="{{ old('shipping_title_outside_dhaka') }}">
                                @error('shipping_title_outside_dhaka')
                                    <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                <label for="shipping_amount_outside_dhaka" class="form-label">Shipping Amount (Outside Dhaka)</label>
                                <input type="number" step="0.01" class="form-control @error('shipping_amount_outside_dhaka') is-invalid @enderror"
                                       name="shipping_amount_outside_dhaka" value="{{ old('shipping_amount_outside_dhaka') }}">
                                @error('shipping_amount_outside_dhaka')
                                    <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                        </div>
    ...
    @enderror
                            ...
                            <div class="col-sm-3 mb-3">
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" value="1" name="top_rated" />
                                        <span class="slider round"></span>
                                    </label>
                                    @error('topsale')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-sm-3 mb-3">
                                <div class="form-group">
                                    ...
                                    <label class="switch">
                                        <input type="checkbox" value="1" name="top_selling" />
                                        <span class="slider round"></span>
                                    </label>
                                    @error('topsale')
                                        <span class="invalid-feedback" role="alert">
