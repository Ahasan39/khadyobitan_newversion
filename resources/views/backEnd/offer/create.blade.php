...
<div class="container">
    ...
    <form action="{{ route('offers.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="title" class="form-control" placeholder="Ex: বিশেষ অফারঃ আজকে ৩০% ছাড়" required>
        </div>

        {{-- Description --}}
        <div class="mb-3">
            <label>Description</label>
            <textarea name="description" class="form-control" placeholder="Offer details..." ></textarea>
        </div>
