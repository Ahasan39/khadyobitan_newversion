...
@section('title', 'Customer Product Review')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex justify-content-between align-items-center">
                    <h4 class="page-title mb-0">Customer Product Review</h4>
                </div>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="button-list custom-btn-list">
                                                    {{-- <a href="{{ route('customers.profile', ['id' => $review->id]) }}"
                                                        class="btn btn-xs btn-blue waves-effect waves-light"><i
                                                            class="fe-eye"></i>
                                                    </a> --}}

                                                    @if ($review->status == 1)
                                                        <form method="post" action="{{ route('customer_reviews.inactive') }}"
                                                            class="d-inline">
                                                            @csrf
                                                    ...
                                                    @else
                                                        <form method="post" action="{{ route('customer_reviews.active') }}"
                                                            class="d-inline">
                                                            @csrf
                                                            <input type="hidden" value="{{ $review->id }}"
                                                                name="hidden_id">
                                                    ...
                                                    <form method="post"
                                                        action="{{ route('product_reviews.destroy', $review->id) }}"
                                                        class="d-inline">
                                                        @csrf
