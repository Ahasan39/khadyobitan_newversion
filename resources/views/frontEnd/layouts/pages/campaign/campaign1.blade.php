                                        ...
                                        <form action="{{ route('customer.ordersave') }}" method="POST"
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5 class="potro_font">👇 অর্ডারটি কনফারম করতে আপনার ইনফরমেশন দিন
                                                    </h5>
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
                                                                    ...
                                                                    @foreach ($shippingcharge as $key => $value)
                                                                        <div class="area-item "
                                                                            ...
                                                                            <input name="area"
                                                                                ...
                                                                                type="radio" value="1">
                                                                            <label
                                                                                for="area-{{ $value->id }}">{{ $value->name }}</label>
                                                                        </div>
                                                                    @endforeach
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <button class="order_place confirm_order"
                                                                    type="submit">কনফার্ম অর্ডার </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-body cartlist  table-responsive">
                                                <table
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <tr>
                                                            <th colspan="2" class="text-end px-4">Delivery Charge
                                                            </th>
                                                            <td>
