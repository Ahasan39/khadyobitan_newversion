...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset($generalsetting->favicon ?? ' ' ) }}" alt="webleez" />
    <meta name="author" content="webleez" />
    @php
...
<style>
    :root {
        ...
        --footer-color: {{ $theme->footer_color ?? '#ffffff' }};
        --text-color: {{ $theme->text_color ?? '#000000' }};
        --button-color: {{ $theme->button_color ?? '#007bff' }};
        --add-to-cart-color: {{ $theme->add_to_cart_color ?? '#28a745' }};
        --price-color: {{ $theme->price_color ?? '#dc3545' }};
        --single_order_color: {{ $theme->single_order_color ?? '#dc3545' }};
        --checkout_order_color: {{ $theme->checkout_order_color ?? '#dc3545' }};
        --checkout_header_color: {{ $theme->checkout_header_color ?? '#dc3545' }};
    }
</style>
...
<!--@include('partials.payment-warning')-->
                    ...
                    <div class="col-sm-12">
                        <div class="copyright">
                            <p>Copyright © {{ date('Y') }} {{ $generalsetting->name ?? ' ' }}. All rights reserved.
                                Developed By <a href="https://webleez.com">webleez</a>
                        </div>
                    </div>
                </div>
            </div>
