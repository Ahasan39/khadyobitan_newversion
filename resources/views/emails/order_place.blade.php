...
<div style="background:#fff; width:90%;margin:0 auto !important">
    ...
    <tbody>
        <tr style="text-align:center">
            <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
               <img src="https://giftshopbd.webleez.com/public/frontEnd/images/giftshopbd-logo.webp" style="width:180px;margin-top:15px">
             </td>
        </tr>
    </tbody>
</table>
    <table class="body-wrap" style="background:#fff; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;  font-size: 16px; width: 100%; margin: 0;padding:0 30px">
        <tbody style="background:#fff">
            ...
            <tr>
                <td style="padding:30px 0;border:0">Thanks — Your order was placed successfully. Order ID #{{$order->invoice_id}}. You will receive a processing email as soon as possible. or check the status of your order from <a href="https://giftshopbd.webleez.com/customer/orders" style="font-weight:900;color:blue">here</a></td></br>
            </tr>
        </tbody>
    </table>
            ...
            <tr>
                <td>
                    <ul style="padding:0 !important">                       
        				<li style="list-style: none; margin: 0 5px; height: 40px; width: 40px; text-align: center; line-height: 40px; background: #4551F7; border-radius: 50px;float:left !important"><a href="https://www.facebook.com/websolutionitcom/"><img src="https://giftshopbd.webleez.com/public/frontEnd/images/facebook-f-brands.png"  style="margin-top: 8px;height: 25px;" /></a></li>
        				                    
        				<li style="list-style: none; margin: 0 5px; height: 40px; width: 40px; text-align: center; line-height: 40px; background: #4DBC60; border-radius: 50px;float:left !important"><a href="https://wa.link/zw696d"><img src="https://giftshopbd.webleez.com/public/frontEnd/images/whatsapp-brands.png" style="margin-top: 8px;height: 25px;" /></a></li>
        			</ul>
    			</td>
			</tr>
        </tbody>
