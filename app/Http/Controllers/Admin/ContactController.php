...
class ContactController extends Controller
{
    ...
    public function userMessage()
    {
        ...
        return view('backEnd.contact.userMessage', compact('userMessages'));
    }
    ...
    public function userMessageShow($id)
    {
            ...
            return view('backEnd.contact.userMessageShow', compact('userMessage'));
    }    

    public function userMessageDelete(Request $request)
    {
        $delete_data = UserMessage::find($request->hidden_id);
        $delete_data->delete();
        Toastr::success('Success','Data delete successfully');
        return redirect()->back();
    }
